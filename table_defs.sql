...
CREATE INDEX tickers_lastupdated ON tickers(lastupdated);

CREATE INDEX prices_lastupdated ON prices(lastupdated);

CREATE INDEX prices_frequency ON prices(frequency);

CREATE INDEX fundamentals_lastupdated ON fundamentals(lastupdated);